...
const MovieCard: React.FC<IMovieCard> = ({
  ...
  return (
    <div
      className="show-box hover:scale-110 hover:shadow-2xl hover:opacity-90 hover:border-amber-400 hover:border-2"
      onClick={() => {
      ...
      <div className="bg-[#2f3238]">
        ...
        <div className="info">
          <div className="text-white pt-[15px] pr-[10px] pb-[15px] pl-[10px] w-[100%] align-middle">
            ...
            <p className="block text-[19px] font-bold leading-[27px] mt-[10px] w-[100%]">
              {title}
            </p>
            <p className="mr-[10px] text-[13px] font-medium table uppercase leading-[20px] w-[100%]">
              * {voteAverage} / 10
            </p>
          </div>
        </div>
